...
class WikiSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        self.start_urls[1] = "https://en.wikipedia.org/w/index.php?title=Steve_Jobs&diff=next&oldid=264585238"
        # self.start_urls[1] = "https://en.wikipedia.org/w/index.php?diff=281954&oldid=281953&title=Steve_Jobs"
